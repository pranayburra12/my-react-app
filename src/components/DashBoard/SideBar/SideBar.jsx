      ...
      <ul class="navigation">
        <li>
          <a href="# " className="inner_li">
            ...
            <button className="cibil-score" onClick={navigateDemart}>{"DMart"}</button>
          </a>
        </li>
        <li>
          <a href="" className="inner_li">
            ...
            {/* <h3>CBIL Score</h3> */}
            <button className="cibil-score" onClick={handleChange}>{"CBIL Score"}</button>
          </a>
        </li>
        <li>
          <a href="" className="inner_li">
            <img src={Sip} alt="" />
            <button className="cibil-score" onClick={navigettoSip}>{"SIP Calculator"}</button>
          </a>
        </li>
        <li>
          <a href="" className="inner_li">
            <img src={SideRound} alt="SideRound" />
            <button className="cibil-score" onClick={navigettoInvestmeTracker}>{"Investment Tracker"}</button>
          </a>
        </li>
        <li>
          <a href="" className="inner_li">
            <img src={Wallet} alt="wallet" />
            <button className="cibil-score" onClick={navigettoInvestmeTracker}>{"Expense Management"}</button >
          </a>
        </li>
        <li>
          <a href="" className="inner_li">
